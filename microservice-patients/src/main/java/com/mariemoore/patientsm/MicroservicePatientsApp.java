...
public class MicroservicePatientsApp {
	...
	public CommandLineRunner initData(PatientService patientService ){
		...
		return args -> {
			patientService.createPatient(new Patient("1", "John", "Doe", new Date(45, 5, 24), "F", Arrays.asList("1 Brookside St"), "100-222-3333"));
			patientService.createPatient(new Patient("2","Jane", "Doe", new Date(45, 5, 24), "M", Arrays.asList("2 High St"), "200-333-4444"));
			patientService.createPatient(new Patient("3","Alice", "Smith", new Date(104, 5, 18), "M", Arrays.asList("3 Club Road"), "300-444-5555"));
			patientService.createPatient(new Patient("4","Bob", "Johnson", new Date(102, 5, 28), "F", Arrays.asList("4 Valley Dr"), "400-555-6666"));
		};
	}
}
